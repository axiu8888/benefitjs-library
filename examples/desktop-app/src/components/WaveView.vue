...
import { local_mqtt as mqtt } from "../public/local-mqtt";
...
onMounted(() => {
  setTimeout(() => {
    ...
    container?.setAttribute("width", `${document.body.clientWidth * 0.9}`);
    container?.setAttribute("height", `${document.body.clientHeight * 0.7}`);
