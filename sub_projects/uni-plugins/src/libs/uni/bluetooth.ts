...
export namespace bluetooth {
    ...
    export class BluetoothClient<T extends BluetoothClient<T>> extends uniapp.BluetoothClient<T> {
        ...
        constructor(uuid: uniapp.GattUUID,
            autoConnect: boolean = false,
            useNative: boolean = support()) {
        ...
        private _intervalNativeHandler(msg: BlePluginMessage) {
            try {
                //this.print('_intervalNativeHandler ==>: ' + JSON.stringify(msg));
                ...
                switch (msg.type) {
                    ...
                    case 'onCharacteristicChanged':
                        super.isConnected = true;
                        super.callListenersFn<uniapp.OnBleClientListener<T>>(l => l.onCharacteristicChanged(_this, msg.mac, binary.hexToBytes(msg.value), undefined as any), 'onCharacteristicChanged');
                        break;
                    case 'onMtuChanged':
                        // 暂不支持
                        break;
