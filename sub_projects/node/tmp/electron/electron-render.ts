import { binary, logger, processEnv, utils, GattUUID } from "@benefitjs/core";
...
export namespace ElectronRender {
  ...
  export namespace ipc {
     ...
     * 消息
     */
    const manager = new rpc.Manager((req: rpc.Request) => {
      // 返回模块对象
      //@ts-ignore
    ...
    export function invoke(target: string, fn: string, ...args: any) {
      return manager.invoke(target, fn, args, 30_000, (req: any) => {
